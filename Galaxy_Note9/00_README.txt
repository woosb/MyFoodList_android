EMULATOR SKIN
-------------
The skin consists of background, foreground and buttons.
...
These buttons are just additional features that enable you to control the emulator skin aside from on-device buttons/keyboard.
